...
function systemPrompt() {
  return [
    ...
    'For chart changes, use exact public OpenAlgo Charts APIs and exact indicator ids when supplied by the skill catalogue. Prefer actions over telling the user to click manually. For any requested chart mutation, verify that the requested action is actually supported by the supplied chart context/API before claiming success. If the action result cannot be verified, say it was requested but not confirmed.'
