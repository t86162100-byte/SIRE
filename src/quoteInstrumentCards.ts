...
function installStyles() {
  ...
  style.textContent = `
    .sire-tab-quote .symbol-list .symbol-row {
      ...
      align-items:start!important;gap:8px 14px!important;min-height:116px!important;padding:18px!important;border-radius:22px!important;
    ...
    .sire-tab-quote .symbol-list .symbol-row>span:first-child{grid-column:1;grid-row:1;min-width:0;display:flex!important;flex-direction:column!important;align-items:flex-start!important;gap:6px!important;text-align:left!important}
    .sire-tab-quote .symbol-list .symbol-row>span:first-child b{display:block!important;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:17px!important;font-weight:850!important;line-height:1.15!important}
    .sire-tab-quote .symbol-list .symbol-row>span:first-child small{font-size:12px!important;opacity:.52!important;letter-spacing:.04em!important}
    .sire-tab-quote .symbol-list .symbol-row .sire-quote-price{grid-column:2;grid-row:1;align-self:start;text-align:right;min-width:82px;font-size:18px!important;font-weight:900!important;line-height:1.15!important;font-variant-numeric:tabular-nums;white-space:nowrap}
    ...
    .sire-tab-quote .symbol-list .symbol-row .sire-quote-details{grid-column:1/-1;grid-row:2;display:flex;flex-wrap:wrap;gap:8px 18px;min-height:18px;color:rgba(235,240,250,.58);font-size:11px;font-weight:650;letter-spacing:.02em;font-variant-numeric:tabular-nums}
    .sire-tab-quote .symbol-list .symbol-row .sire-quote-details b{color:rgba(235,240,250,.9);font-weight:800}
    .sire-tab-quote .symbol-list .symbol-row>em{position:absolute!important;right:16px;bottom:15px;z-index:2;font-style:normal!important;font-size:9px!important;opacity:.45!important}
  `;
